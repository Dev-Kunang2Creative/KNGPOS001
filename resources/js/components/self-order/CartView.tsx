...
export default function CartView({
    ...
    return (
        <div className="bg-surface text-on-surface font-body-md pt-safe flex min-h-screen flex-col antialiased">
            ...
            <main className="md:px-lg mx-auto flex w-full max-w-3xl flex-1 flex-col gap-4 px-4 pt-[80px] pb-[200px]">
                ...
                <section className="bg-surface-container-lowest border-outline-variant flex flex-col gap-4 rounded-xl border p-4 shadow-sm">
                    <div className="flex flex-col gap-1">
                        ...
                        <input
                            ...
                            className="bg-surface-container-low border-outline-variant text-body-md text-on-surface placeholder:text-on-surface-variant focus:border-primary focus:ring-primary w-full rounded-lg border p-2 transition-colors focus:ring-1 focus:outline-none"
                ...
                <section className="bg-surface-container-lowest border-outline-variant rounded-xl border p-4 shadow-sm">
                    ...
                    <textarea
                        ...
                        className="bg-surface-container-low border-outline-variant text-body-md text-on-surface placeholder:text-on-surface-variant focus:border-primary focus:ring-primary w-full resize-none rounded-lg border p-2 transition-colors focus:ring-1 focus:outline-none"
            ...
            <div className="bg-surface-container-lowest border-outline-variant fixed right-0 bottom-[96px] left-0 z-40 mx-auto w-full max-w-md border-t shadow-[0px_-4px_12px_rgba(0,0,0,0.05)]">
