...
export default function CartView({
 ...
 <h1 className="text-base font-bold text-on-surface ml-2 flex-1 pr-8 text-center">Keranjang</h1>
 </header>
 ...
 <h2 className="text-sm font-semibold text-on-surface">Tempat Duduk</h2>
 <span className="bg-primary text-white text-sm font-semibold rounded-full px-3 py-1">{table.name}</span>
 </section>

 <section className="bg-secondary-fixed text-on-secondary-fixed rounded-xl border border-[#d4af37] p-4 shadow-sm">
 <p className="text-sm text-on-secondary-fixed">Pastikan meja kamu sudah sesuai dengan yang tertera di atas.</p>
 </section>
 ...
 <label htmlFor="customer-name" className="text-sm font-semibold text-on-surface">
 Nama
 </label>
 <input
 id="customer-name"
 ...
 className="bg-surface-container-low border-outline-variant text-sm text-on-surface placeholder:text-on-surface-variant focus:border-primary focus:ring-primary w-full rounded-lg border p-2 transition-colors focus:ring-1 focus:outline-none"
 ...
 <h2 className="text-base font-bold text-on-surface mt-2 mb-1">Rincian Pesanan</h2>
 ...
 <h3 className="text-sm font-semibold text-on-surface mb-1">{item.name}</h3>
 {item.notes && <p className="text-sm text-on-surface-variant">{item.notes}</p>}
 <div className="mt-4 flex items-center gap-2">
 <p className="text-base font-bold text-on-surface">Rp {(item.price * item.quantity).toLocaleString('id-ID')}</p>
 <button
 ...
 <span className="text-sm font-semibold text-on-surface w-4 text-center">{item.quantity}</span>
 <button
 onClick={() => onUpdateQuantity(item.menu_item_id, 1)}
 ...
 <h3 className="text-sm font-semibold text-on-surface mb-1">Catatan Tambahan</h3>
 <p className="text-sm text-on-surface-variant mb-2">Opsional</p>
 <textarea
 value={notes}
 onChange={(e) => setNotes(e.target.value)}
 className="bg-surface-container-low border-outline-variant text-sm text-on-surface placeholder:text-on-surface-variant focus:border-primary focus:ring-primary w-full resize-none rounded-lg border p-2 transition-colors focus:ring-1 focus:outline-none"
 ...
 className={`text-sm font-semibold flex w-full items-center justify-center rounded-full py-4 shadow-[0px_4px_12px_rgba(0,0,0,0.1)] transition-transform duration-150 active:scale-[0.98] ${
