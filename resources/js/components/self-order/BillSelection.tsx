    ...
    return (
        <div className="mx-auto flex w-full max-w-md flex-grow flex-col px-4 pt-24 pb-32">
            <div className="mb-6 text-center">
                <h1 className="text-headline-lg-mobile text-primary mb-2">Bagaimana Anda ingin memesan?</h1>
                <p className="text-body-md text-on-surface-variant">Pilih cara Anda ingin mengelola pesanan untuk sesi ini.</p>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                >
                    <div className="flex items-start gap-4">
                        <div className="bg-primary-container text-on-primary-container flex h-12 w-12 shrink-0 items-center justify-center rounded-full">
                            <span className="material-symbols-outlined icon-fill">lock_open</span>
                        </div>
                        <div className="flex-grow pr-2">
                            <h2 className="text-label-lg text-on-surface mb-1">Open Bill</h2>
                ...
                >
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-grow pr-2">
                            <h2 className="text-label-lg text-on-surface mb-1">Close Bill</h2>
                            <p className="text-body-md text-on-surface-variant">
            ...
            <div className="bg-surface/90 border-surface-variant pb-safe fixed bottom-0 left-0 right-0 mx-auto max-w-md z-40 w-full border-t p-4 shadow-[0px_-8px_24px_rgba(0,0,0,0.08)] backdrop-blur-md">
                <div className="mx-auto max-w-md">
                    <button
                        ...
                        className={`text-label-lg flex h-12 w-full items-center justify-center gap-1 rounded-full transition-all duration-200 ${
                            selectedType
