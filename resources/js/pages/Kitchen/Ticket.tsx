...
type Props = {
    kitchenOrder: KitchenOrderData;
    stationName: string;
};

export default function Ticket({ kitchenOrder, stationName }: Props) {
    ...
    return (
        <>
            <Head title={`Tiket Kitchen #${order.id}`} />
            <style>{`
            ...
            <main className="mx-auto w-[72mm] max-w-full p-3 font-mono text-sm text-black">
                <div className="text-center">
                    ...
                    <p className="text-xs font-semibold">KITCHEN — {stationName}</p>
                </div>
                ...
                <div className="space-y-1 text-xs">
                    ...
                    <div className="flex justify-between gap-3">
                        <span>Waktu</span>
                        <span>{kitchenOrder.sent_at ? new Date(kitchenOrder.sent_at).toLocaleString('id-ID') : '-'}</span>
                    </div>
                </div>
                ...
                <div className="my-3 border-t border-dashed border-black" />
                <p className="text-center text-xs">*** TIKET DAPUR ***</p>
